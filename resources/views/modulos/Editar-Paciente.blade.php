					...
					<div class="row">
						<div class="col-md-12">
							...
							<div class="form-group col-md-12">
								...
								<input type="text" name="name" class="form-control input-md"  value="{{$paciente->name}}"  required="">
							</div>
							...
							<div class="form-group col-md-6">
								<h4>Documento:</h4>
								<input type="text" name="documento" class="form-control input-md"  value="{{$paciente->documento}}"  required="">
							</div>

							<div class="form-group col-md-6">
								<h4>Telefono:</h4>
								<input type="text" name="telefono" class="form-control input-md"  value="{{$paciente->telefono}}"  required="">
							</div>
