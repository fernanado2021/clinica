					...
					<div class="row">
						<div class="col-md-12">
							...
							<div class="form-group col-md-6">
								<h4>Documento</h4>
								<input type="text" name="documento"  maxlength="10" class="form-control input-md" required="">
							</div>
							...
							<div class="form-group col-md-6">
								<h4>Telefono:</h4>
								<input type="text" maxlength="10" class="form-control input-md" name="telefono" required="">
							</div>
